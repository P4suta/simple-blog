-- Reader additions arrive in the default theme: the article meta line
-- (publication and update dates, reading time), a table of contents, the
-- home pager, the tag index table, and print rules that hide navigation
-- and controls. As always, only stylesheets still equal to the previous
-- default verbatim are updated; anything edited or emptied is untouched.
