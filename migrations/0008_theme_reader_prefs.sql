-- Reader display preferences (measure, text size, scheme) arrive in the
-- default theme as data-attribute hooks driven by prefs.js. As always, only
-- stylesheets still equal to the previous default verbatim are updated.
